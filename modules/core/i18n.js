(function (global) {
  ...
  var DICT = {
    pt: {
      ...
      invest_btn_nowpayments_generate: 'Depositar Agora',
      invest_modal_subtitle_nowpayments: 'Pagamento via NowPayments. Dados do endereço e valor em cripto são gerados automaticamente.',
      np_status_label: 'Status Pagamento NowPayments',
      np_status_pending_click: 'Aguardando clique — gere a fatura',
      np_amount_usd: 'Valor USD:',
      np_amount_crypto: 'Valor a pagar em cripto:',
      np_order: 'Order / Invoice:',
      np_waiting_click_text: 'Clique no botão dourado abaixo para gerar endereço de pagamento.',
      np_open_invoice: 'Abrir página NowPayments (QR + status em tempo real)',
      np_qr_scan_hint: 'Abra sua carteira (Trust/Klever/MetaMask) e escaneie o QR para pagar automaticamente.',
      ...
      dev_process_binary: 'Processar Bônus Binário (US$10 Fixo)',
      ...
      dev_bonus_claimed: 'Bônus de $100 creditado!',
      ...
      auth_register_subtitle: 'Comece a investir hoje mesmo',
      auth_label_name: 'Nome Completo',
      auth_ph_name: 'João da Silva',
      auth_label_email: 'E-mail',
      auth_ph_email: 'voce@email.com',
      auth_label_username: 'Username',
      auth_ph_username: 'joao_gold (letras, números, _ - .)',
      auth_label_password: 'Senha',
      auth_ph_password: 'Mínimo 6 caracteres',
      auth_label_confirm_password: 'Confirmar Senha',
      auth_ph_confirm_password: 'Digite a senha novamente',
      auth_btn_login: 'Entrar',
      auth_btn_register: 'Criar Conta',
      auth_btn_send_link: 'Enviar Link de Recuperação',
      auth_btn_reset_password: 'Alterar Senha',
      auth_btn_back_login: '← Voltar para o login',
      auth_forgot_title: 'Recuperar Senha',
      auth_forgot_subtitle: 'Digite seu email para receber um link',
      auth_reset_title: 'Redefinir Senha',
      auth_reset_subtitle: 'Crie uma nova senha forte',
      auth_confirm_title: 'Confirmando seu email...',
      auth_confirm_subtitle: 'Aguarde um momento',
      auth_no_account: 'Não tem conta?',
      auth_have_account: 'Já tem conta?',
      auth_register_here: 'Crie aqui',
      auth_login_here: 'Entre aqui',
      auth_forgot_link: 'Esqueceu a senha?',
      auth_forgot_link_action: 'Recuperar',
      auth_sponsor_connected: '🔗 Patrocinador conectado:',
      auth_sponsor_notfound: '⚠️ Link de indicação inválido. Contate seu patrocinador.',
      ...
      auth_forgot_sent: '📩 Link de recuperação enviado para <b>{email}</b>',
      ...
      auth_terms: 'Ao criar a conta, você concorda com os Termos de Uso e Política de Privacidade.',
      auth_lang_label: 'Idioma',
    },
    ...
    en: {
      ...
      invest_btn_nowpayments_generate: 'Deposit Now',
      invest_modal_subtitle_nowpayments: 'Payment via NowPayments. Address and crypto amount data are generated automatically.',
      np_status_label: 'NowPayments Payment Status',
      np_status_pending_click: 'Waiting — generate invoice',
      np_amount_usd: 'USD Amount:',
      np_amount_crypto: 'Crypto amount to pay:',
      np_order: 'Order / Invoice:',
      np_waiting_click_text: 'Click the golden button below to generate a payment address.',
      np_open_invoice: 'Open NowPayments page (QR + real-time status)',
      np_qr_scan_hint: 'Open your wallet (Trust/Klever/MetaMask) and scan the QR to pay automatically.',
      ...
      auth_login_subtitle: 'Welcome back to G7 Gold Invest',
      auth_register_title: 'Create Account',
      auth_register_subtitle: 'Start investing today',
      auth_label_name: 'Full Name',
      auth_ph_name: 'John Smith',
      auth_label_email: 'Email',
      auth_ph_email: 'you@email.com',
      auth_label_username: 'Username',
      auth_ph_username: 'john_gold (letters, numbers, _ - .)',
      auth_label_password: 'Password',
      auth_ph_password: 'At least 6 characters',
      auth_label_confirm_password: 'Confirm Password',
      auth_ph_confirm_password: 'Retype your password',
      auth_btn_login: 'Sign In',
      auth_btn_register: 'Create Account',
      auth_btn_send_link: 'Send Recovery Link',
      auth_btn_reset_password: 'Change Password',
      auth_btn_back_login: '← Back to login',
      auth_forgot_title: 'Forgot Password',
      auth_forgot_subtitle: 'Enter your email to receive a link',
      auth_reset_title: 'Reset Password',
      auth_reset_subtitle: 'Create a new strong password',
      auth_confirm_title: 'Confirming your email...',
      auth_confirm_subtitle: 'Please wait a moment',
      auth_no_account: "Don't have an account?",
      auth_have_account: 'Already have an account?',
      auth_register_here: 'Sign up here',
      auth_login_here: 'Sign in here',
      auth_forgot_link: 'Forgot password?',
      auth_forgot_link_action: 'Recover',
      auth_sponsor_connected: '🔗 Connected with sponsor:',
      auth_sponsor_notfound: '⚠️ Invalid referral link. Please contact your sponsor.',
      auth_required_name: 'Please enter your full name',
      auth_required_email: 'Please enter your email',
      auth_invalid_email: 'Invalid email',
      auth_required_username: 'Please create a username',
      auth_username_taken: 'Username already taken. Choose another.',
      auth_required_password: 'Please enter a password',
      auth_password_min: 'Password must be at least {n} characters',
      auth_passwords_not_match: 'Passwords do not match',
      auth_login_invalid: 'Invalid email/username or password',
      auth_forgot_sent: '📩 Recovery link sent to <b>{email}</b>',
      auth_reset_done: '✅ Password changed successfully!',
      auth_confirm_done: '✅ Email confirmed. Welcome!',
      auth_register_ok: '✅ Account created! Check your email to confirm.',
      auth_logout_ok: 'Signed out.',
    ...
    es: {
      ...
      invest_btn_nowpayments_generate: 'Depositar Ahora',
      invest_modal_subtitle_nowpayments: 'Pago vía NowPayments. Los datos de dirección y valor en cripto son generados automáticamente.',
      np_status_label: 'Estado del Pago NowPayments',
      np_status_pending_click: 'Esperando clic — genere la factura',
      np_amount_usd: 'Valor USD:',
      np_amount_crypto: 'Valor a pagar en cripto:',
      np_order: 'Pedido / Factura:',
      np_waiting_click_text: 'Clic en el botón dorado para generar una dirección de pago.',
      np_open_invoice: 'Abrir página NowPayments (QR + estado en tiempo real)',
      np_qr_scan_hint: 'Abra tu billetera (Trust/Klever/MetaMask) y escanea el QR para pagar automáticamente.',
      invest_cancel_btn: 'Cancelar',
      ...
      dev_process_binary: 'Procesar Bono Binario (US$10 Fijo)',
      ...
      dev_bonus_claimed: '¡Bono de $100 acreditado!',
      ...
      auth_login_subtitle: 'Bienvenido de nuevo a G7 Gold Invest',
      auth_register_title: 'Crear Cuenta',
      auth_register_subtitle: 'Empieza a invertir hoy',
      auth_label_name: 'Nombre Completo',
      auth_ph_name: 'Juan Pérez',
      auth_label_email: 'Correo electrónico',
      auth_ph_email: 'tu@correo.com',
      auth_label_username: 'Nombre de usuario',
      auth_ph_username: 'juan_gold (letras, números, _ - .)',
      auth_label_password: 'Contraseña',
      auth_ph_password: 'Mínimo 6 caracteres',
      auth_label_confirm_password: 'Confirmar Contraseña',
      auth_ph_confirm_password: 'Escribe la contraseña otra vez',
      auth_btn_login: 'Entrar',
      auth_btn_register: 'Crear Cuenta',
      auth_btn_send_link: 'Enviar Enlace de Recuperación',
      auth_btn_reset_password: 'Cambiar Contraseña',
      auth_btn_back_login: '← Volver al inicio de sesión',
      auth_forgot_title: 'Recuperar Contraseña',
      auth_forgot_subtitle: 'Ingresa tu correo para recibir un enlace',
      auth_reset_title: 'Restablecer Contraseña',
      auth_reset_subtitle: 'Crea una nueva contraseña segura',
      auth_confirm_title: 'Confirmando tu correo...',
      auth_confirm_subtitle: 'Por favor espera un momento',
      ...
      auth_forgot_link_action: 'Recuperar',
      auth_sponsor_connected: '🔗 Patrocinador conectado:',
      auth_sponsor_notfound: '⚠️ Enlace de referencia inválido. Contacta a tu patrocinador.',
      auth_required_name: 'Ingresa tu nombre completo',
      auth_required_email: 'Ingresa tu correo electrónico',
      auth_invalid_email: 'Correo inválido',
      auth_required_username: 'Crea un nombre de usuario',
      auth_username_taken: 'Usuario ya existe. Elige otro.',
      auth_required_password: 'Ingresa una contraseña',
      auth_password_min: 'La contraseña debe tener al menos {n} caracteres',
      auth_passwords_not_match: 'Las contraseñas no coinciden',
      auth_login_invalid: 'Correo/usuario o contraseña inválidos',
      auth_forgot_sent: '📩 Enlace de recuperación enviado a <b>{email}</b>',
      auth_reset_done: '✅ ¡Contraseña cambiada con éxito!',
      auth_confirm_done: '✅ Correo confirmado. ¡Bienvenido!',
      auth_register_ok: '✅ ¡Cuenta creada! Verifica tu correo para confirmar.',
      auth_logout_ok: 'Sesión cerrada.',
      auth_terms: 'Al crear la cuenta, aceptas los Términos de Uso y la Política de Privacidad.',
      auth_lang_label: 'Idioma',
    }
  };
