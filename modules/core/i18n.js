(function (global) {
  ...
  var DICT = {
    pt: {
      ...
      invest_deposit_addr_label: 'Endereço de Depósito:',
      ...
      invest_modal_subtitle_nowpayments: 'Depósito automático via NowPayments.',
      np_status_label: 'Status:',
      np_status_pending_click: 'Aguardando...',
      np_amount_usd: 'Valor USD:',
      np_amount_crypto: 'Valor em cripto:',
      np_order: 'ID do Pedido:',
      np_waiting_click_text: 'Clique em Depositar Agora.',
      np_open_invoice: 'Abrir NowPayments',
      np_qr_scan_hint: 'Escaneie com a sua carteira.',
      np_processing: 'Gerando endereço...',
      np_processing_btn: 'Aguarde...',
      np_processing_toast: 'Gerando endereço de depósito...',
      invest_network_label: 'Rede de Depósito',
    ...
    en: {
      ...
      invest_deposit_addr_label: 'Deposit Address:',
      ...
      invest_modal_subtitle_nowpayments: 'Automatic deposit via NowPayments.',
      np_status_label: 'Status:',
      np_status_pending_click: 'Waiting...',
      np_amount_usd: 'USD Amount:',
      np_amount_crypto: 'Crypto Amount:',
      np_order: 'Order ID:',
      np_waiting_click_text: 'Click Deposit Now.',
      np_open_invoice: 'Open NowPayments',
      np_qr_scan_hint: 'Scan with your wallet.',
      np_processing: 'Generating address...',
      np_processing_btn: 'Please wait...',
      np_processing_toast: 'Generating deposit address...',
      ...
      auth_loguin_title: 'Sign In',
      auth_login_subtitle: 'Welcome back to G7 Gold Invest',
      auth_loguin_subtitle: 'Welcome back to G7 Gold Invest',
    ...
    es: {
      ...
      invest_deposit_addr_label: 'Dirección de Depósito:',
      copy_deposit_addr: 'Copiar Dirección',
      invest_btn_simulate: 'Confirmar Depósito Simulado',
      invest_btn: 'Confirmar Inversión',
      invest_btn_nowpayments_generate: 'Depositar Ahora',
      invest_modal_subtitle_nowpayments: 'Depósito automático vía NowPayments.',
      np_status_label: 'Estado:',
      np_status_pending_click: 'Esperando...',
      np_amount_usd: 'Valor USD:',
      np_amount_crypto: 'Valor en cripto:',
      np_order: 'ID del Pedido:',
      np_waiting_click_text: 'Clic en Depositar Ahora.',
      np_open_invoice: 'Abrir NowPayments',
      np_qr_scan_hint: 'Escanea con tu billetera.',
      np_processing: 'Generando dirección...',
      np_processing_btn: 'Espera...',
      np_processing_toast: 'Generando dirección de depósito...',
      invest_cancel_btn: 'Cancelar',
      ...
      auth_loguin_title: 'Iniciar Sesión',
      auth_login_subtitle: 'Bienvenido de nuevo a G7 Gold Invest',
      auth_loguin_subtitle: 'Bienvenido de nuevo a G7 Gold Invest',
